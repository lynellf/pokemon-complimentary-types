...
const inspectWeaknesses = (getWeaknesses) => (userInput) => {
    ...
    const offendingTypes = weaknesses
        .map((weaknessArr, i) => weaknessArr.find((type) => { var _a; return (_a = frequencyTable.get(type)) !== null && _a !== void 0 ? _a : -1 >= 2; }) !==
        undefined
        ? i
        : -1)
        .filter((i) => i !== -1)
...
exports.default = (deps) => {
    const checkUserInput = (0, exports.inspectWeaknesses)(deps.getWeaknesses);
